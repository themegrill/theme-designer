...
/**
 * Returns the capabilities for the popular themes taxonomy.
 *
 * @since  1.0.0
 * @access public
 * @return array
 */
function thds_get_popular_themes_capabilities() {

	$caps = array(
		'manage_terms' => 'manage_popular_themes',
		'edit_terms'   => 'manage_popular_themes',
		'delete_terms' => 'manage_popular_themes',
		'assign_terms' => 'edit_theme_projects',
	);

	return apply_filters( 'thds_get_popular_themes_capabilities', $caps );
}
