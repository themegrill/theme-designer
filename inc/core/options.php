...
/**
 * Returns the popular theme rewrite base. Used for feature archives.
 *
 * @since  1.0.0
 * @access public
 * @return string
 */
function thds_get_popular_theme_rewrite_base() {
	return apply_filters( 'thds_get_popular_theme_rewrite_base', thds_get_setting( 'popular_theme_rewrite_base' ) );
}
